package de.garritfra.daheimkalender.ui.dummy;
...
public class DummyContent {
     ...
     */
    public static final Map<String, Challenge> ITEM_MAP = new HashMap<String, Challenge>();
    ...
    private static Challenge createDummyItem(int position) {
        return new Challenge(String.valueOf(position), "Item " + position, makeDetails(position));
    }
